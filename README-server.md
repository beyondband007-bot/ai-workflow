...
- `token.facemini.com` -> Docker `web/app/db`
- `token.facemini.com/portal/wf003/` -> `wf003-car-export.service`
...
curl -ksS https://token.facemini.com/health/db
curl -ksS https://token.facemini.com/portal/wf003/ | head
```
